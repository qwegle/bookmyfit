...
@Module({
  imports: [
    TypeOrmModule.forFeature([CheckinEntity, SubscriptionEntity, GymEntity, UserEntity, FraudAlertEntity, BookingQrEntity, SessionBookingEntity, SessionSlotEntity]),
    JwtModule.register({
