...
const s = StyleSheet.create({
  ...
  partnerImgWrapper: { width: 122, height: 184, position: 'relative', backgroundColor: colors.surface },
  partnerImg: { width: 122, height: 184, resizeMode: 'cover', backgroundColor: colors.surface },
  discountBadge: {
  ...
  partnerInfo: { flex: 1, minWidth: 0, paddingHorizontal: 12, paddingVertical: 10, gap: 5 },
  ...
  viewRow: { flexDirection: 'row', justifyContent: 'flex-start', marginTop: 2 },
  viewBtn: {
